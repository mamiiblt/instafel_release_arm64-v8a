                ...
                {[
                  {
                    ...
                    benefits: [
                      "Includes all features of Instafel",
                      "Replaces the original app",
                      "More stable than clone variant",
                    ],
                    delay: 0.5,
                  },
                  {
                    ...
                    benefits: [
                      ...
                      "Use without any crash loop risk",
                    ],
                    delay: 0.6,
                  },
                ].map((variant) => (
                          ...
                          <div className="bg-card/50 rounded-xl border p-4">
                            <div className="flex items-center justify-between mb-4">
                              <div className="flex items-center gap-2">
                                ...
                                >
                                  Release v{data.app.ifl_version || "Unknown"}
                                </Badge>
                              </div>
                        ...
                        <TabsContent value="build" className="mt-0">
                          <div className="bg-card/50 rounded-xl border p-4">
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                              ...
                              <InfoCard
                                icon={<BadgeInfo className="h-5 w-5 text-primary" />}
                                title="Instafel Version"
                                value={`${"Release v" + data.app.ifl_version || "Not available"}`}
                              />
                              ...
                              <InfoCard
                                ...
                                value={`v${data.app.version_name + " (" + data.app.version_code + ")" || "Not available"}`}
                              />

                              <Link href={`https://github.com/mamiiblt/instafel/commit/${data.commit}`}>
                                <InfoCard
                                  icon={
