...
public class IflDecoder {
    private static final Logger LOGGER = Logger.getLogger(IflDecoder.class.getName());
    ...
    public ApkInfo decode(File outDir) throws AndrolibException {
        ...
        try {
            ...
            if (mWorker != null) {
                LOGGER.info("Using " + mConfig.getJobs() + " threads for decompiling");
            } else {
                LOGGER.info("Using single thread for decompiling");
            }
