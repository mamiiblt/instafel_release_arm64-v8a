...
public class AppData {
    private Object ifl_ver, ig_ver, ig_ver_code, ig_itype, ig_arch;

    public AppData(Object ifl_ver, Object ig_ver, Object ig_ver_code, Object ig_itype, Object ig_arch) {
        this.ifl_ver = ifl_ver;
        this.ig_ver = ig_ver;
        this.ig_ver_code = ig_ver_code;
        this.ig_itype = ig_itype;
        this.ig_arch = ig_arch;
    }
